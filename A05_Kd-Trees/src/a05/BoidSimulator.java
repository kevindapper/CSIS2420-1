...
public class BoidSimulator {
    ...
    private static Iterable<Boid> lookUpBoids(EnhancedKdTreeST<Boid> bkd, Iterable<Point2D> points) {
    ...
    public static void main(String[] args) {  
        ...
        while (true) {
            ...
            // The entire EnhancedKdTreeST must be rebuilt every frame. Since the boids
            // are random, we expect a roughly balanced tree, despite the
            // lack of balancing in EnhancedKdTreeST.
            
            EnhancedKdTreeST<Boid> bkd = new EnhancedKdTreeST<Boid>();
            for (int i = 0; i < NUM_BOIDS; i++) {
