 ...
 *  @author Kevin Wayne
 */
public class TopologicalOrder {//modified from Topological.java
    ...
    public static void main(String[] args) { 	
    	String filename = "src/graphUndirected/res/diGraph.txt";//  = args[0];
        String delimiter = " "; //args[1];
        SymbolDigraph sg = new SymbolDigraph(filename, delimiter);
        TopologicalOrder topological = new TopologicalOrder(sg.digraph());
